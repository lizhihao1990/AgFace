#' An import function for glasshouse climate files
#' 
#' Imports and processes a single DAT file that was created by the Credswick glasshouse controller
#' @param data Filename of the DAT file. No Default.
#' GlasshouseImport(data)

GlasshouseImport <- function (data) {
...
my.datetime.rep <- unlist(lapply(my.datetime, function(x) rep(x, 5)))
...
sensor.name.table <- data.frame(SensorID = 1:5,
