...
the.data <- "12-11-2014-12_15_08_zim_probe_datas_raw_LT_2014-10-11_22_14_00_to_2014-11-12_01_15_00.csv"
...
p <- ggplot(ZIM[!is.na(ZIM$value) & 
     ...
     p <- p + geom_line(aes(colour = Cultivar, linetype = Channel))
...
ggsave(file = "Leaf_water_turgor_during_post-anthesis_heat_shock.pdf",
       width = 12, height = 8)
